...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($tanggal_input === '' || $merk_hp === '' || $nama_hp === '' || $deskripsi === '' || $stok < 0 || $harga < 0) {
        ...
        $stmt = mysqli_prepare($conn, "UPDATE hp SET tanggal_input=?, merk_hp=?, nama_hp=?, deskripsi=?, stok=?, harga=? WHERE id_hp=?");
        mysqli_stmt_bind_param($stmt, "ssssiii", $tanggal_input, $merk_hp, $nama_hp, $deskripsi, $stok, $harga, $id);
...
<body>
    <div class="container">
        <header>
            <h1><i class="fa-solid fa-edit"></i> Ubah Data HP</h1>
        ...
        <div class="card">
            ...
            <form method="POST" action="" autocomplete="off">
                <div class="form-group">
                    ...
                    <input type="date" id="tanggal_input" name="tanggal_input" value="<?php echo htmlspecialchars($row['tanggal_input']); ?>" required>
                </div>
                <div class="form-group">
                    <label for="merk_hp">Merk HP</label>
                    <input type="text" id="merk_hp" name="merk_hp" maxlength="250" value="<?php echo htmlspecialchars($row['merk_hp']); ?>" required>
                </div>
                <div class="form-group">
                    <label for="nama_hp">Nama HP</label>
                    <input type="text" id="nama_hp" name="nama_hp" value="<?php echo htmlspecialchars($row['nama_hp']); ?>" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="stok" name="stok" min="0" value="<?php echo htmlspecialchars($row['stok']); ?>" required>
                </div>
                <div class="form-group">
                    <label for="harga">Harga</label>
                    <input type="number" id="harga" name="harga" min="0" step="1000" value="<?php echo htmlspecialchars($row['harga']); ?>" required>
                </div>
                <div class="form-actions">
                    <a href="index.php" class="btn btn-back"><i class="fa-solid fa-arrow-left"></i> Kembali</a>
                    <button type="submit" class="btn"><i class="fa-solid fa-save"></i> Update Data</button>
                </div>
            </form>
        </div>
